...
export default Vue.extend({
  ...
  methods: {
    ...
    async query() {
      this.display = true;
      const url = `/Report/${this.form.monitor}/${this.form.reportType}/${this.form.date}`;
    ...
    downloadReport() {
      ...
      const url = `${baseUrl}Excel/Report/${this.form.monitor}/${this.form.reportType}/${this.form.date}`;
