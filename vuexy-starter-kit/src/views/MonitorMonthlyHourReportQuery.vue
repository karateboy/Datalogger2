...
export default Vue.extend({
  ...
  methods: {
    ...
    async query() {
      this.display = true;
      const url = `/MonitorMonthlyHourReport/${this.form.monitor}/${this.form.monitorType}/${this.form.date}`;
    ...
    downloadReport() {
      ...
      const url = `${baseUrl}Excel/MonitorMonthlyHourReport/${this.form.monitor}/${this.form.monitorType}/${this.form.date}`;
