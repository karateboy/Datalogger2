...
object PicarroG2131iCollector extends AbstractDrv(_id = "picarroG2131i", desp = "Picarro G2131i",
  protocols = List(Protocol.tcp)) {
  override val logger: Logger = Logger(this.getClass)
  private val predefinedIST = List(
  ...
  private val dataAddress: List[Int] = List(0, 4)
  ...
  override def factory(id: String, protocol: ProtocolParam, param: String)(f: AnyRef, fOpt:Option[AnyRef]): Actor = {
    val f2 = f.asInstanceOf[PicarroG2131iCollector.Factory]
...
class PicarroG2131iCollector @Inject()(instrumentOp: InstrumentDB, monitorStatusOp: MonitorStatusDB,
  ...
  import PicarroG2131iCollector._
