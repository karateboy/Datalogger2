...
object VocReader {
  ...
  def start(configuration: Configuration, actorSystem: ActorSystem, monitorOp: MonitorOp, monitorTypeOp: MonitorTypeOp,
            recordOp: RecordOp) = {
  ...
  def props(config: VocReaderConfig, monitorTypeOp: MonitorTypeOp,
            recordOp: RecordOp) =
...
class VocReader(config: VocReaderConfig, monitorTypeOp: MonitorTypeOp, recordOp: RecordOp)
