...
(adam6017Drv: Adam6017, adam6017Factory: Adam6017Collector.Factory,
 ...
 nh3Factory: Nh3Collector.Factory,
 ...
 tca08Factory: Tca08Collector.Factory,
 picarroG2401Factory: PicarroG2401.Factory,
 picarroG2131iFactory: PicarroG2131iCollector.Factory,
 ...
 ecotechS10Factory: EcotechS10Collector.Factory,
 ecotechS30Factory: EcotechS30Collector.Factory,
 ecotechS40Factory: EcotechS40Collector.Factory,
 ecotechS50Factory: EcotechS50Collector.Factory,
 ...
 PseudoDevice3Factory: PseudoDevice3.Factory,
 monitorTypeOp: MonitorTypeDB) extends InjectedActorSupport {
  ...
  private val otherDeviceList = Seq(
    ...
    InstrumentType(Nh3Collector, nh3Factory),
    ...
    InstrumentType(Tca08Collector, tca08Factory),
    InstrumentType(PicarroG2401, picarroG2401Factory),
    InstrumentType(PicarroG2131iCollector, picarroG2131iFactory),
    ...
    InstrumentType(EcotechS10Collector, ecotechS10Factory),
    InstrumentType(EcotechS30Collector, ecotechS30Factory),
    InstrumentType(EcotechS40Collector, ecotechS40Factory),
    InstrumentType(EcotechS50Collector, ecotechS50Factory),
    ...
    InstrumentType(PseudoDevice3, PseudoDevice3Factory)
  )
